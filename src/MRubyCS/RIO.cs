...
public class RIO : RObject
{
    ...
    public RIO(RClass klass, Stream stream, bool leaveOpen = false) : base(klass)
    {
        Stream = stream;
        LeaveOpen = leaveOpen;
    }
...
/// </summary>
public sealed class RFile : RIO
{
    public string Path { get; }

    public RFile(RClass klass, Stream stream, string path, bool leaveOpen = false)
        : base(klass, stream, leaveOpen)
    {
        Path = path;
    }
}
