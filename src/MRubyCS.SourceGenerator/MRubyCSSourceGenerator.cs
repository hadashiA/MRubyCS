...
public class MRubyCSSourceGenerator : IIncrementalGenerator
{
    ...
    [
        ...
        new("Quote", "quote"),
        new("Union", "union"),
        new("TryConvert", "try_convert"),
        new("LastMatch", "last_match"),
        new("NamedCaptures", "named_captures"),
        new("Begin", "begin"),
        new("End", "end"),
        new("Captures", "captures"),
        new("PreMatch", "pre_match"),
        new("PostMatch", "post_match"),
        new("String", "string"),
        new("ValuesAt", "values_at"),
        new("Offset", "offset"),
        new("Sub", "sub"),
        new("SubBang", "sub!"),
        new("Gsub", "gsub"),
